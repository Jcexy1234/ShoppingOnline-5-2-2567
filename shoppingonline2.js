...
class Account {
  ...
  printOrderDetail() {
    ...
    console.log(" มีในตระกร้าทั้งหมด : " + this.shoppingCart.lineItem + "รายการ");
  }
...
class ShoppingCart {
  ...
  printShoppingCart() {
    for (let i = 0; i < this.lineItems.length; i++) {
      console.log("รายการที่ " + (i + 1) + " " + this.lineItems[i].
      getDetail());
    }
    console.log("ราคารวมในตระกร้าทั้งหมด :" + this.calcTotal()+ "บาท");
}
...
const main = () => {
  ...
  const shoppingCart = new ShoppingCart("05/02/2567");
